...
ActiveRecord::Schema.define(version: 20200323131342) do
  ...
  create_table "refinery_business_billables", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["bill_happy_rabbit"], name: "INDEX_rb_billables_ON_bill_happy_rabbit"
    ...
    t.index ["billed_company_id"], name: "INDEX_rb_billables_ON_billed_company_id"
    t.index ["billed_invoice_id"], name: "INDEX_rb_billables_ON_billed_invoice_id"
  ...
  create_table "refinery_marketing_addresses", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "owner_id"
    t.string "address1"
    t.string "address2"
    t.string "city"
  ...
  create_table "refinery_marketing_links", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "contact_id"
    t.integer "linked_id"
