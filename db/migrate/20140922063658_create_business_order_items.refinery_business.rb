# This migration comes from refinery_sales_orders (originally 2)
class CreateBusinessOrderItems < ActiveRecord::Migration
  ...
  def down
    remove_index :refinery_business_order_items, :sales_order_id
    remove_index :refinery_business_order_items, :order_detail_id
    remove_index :refinery_business_order_items, :order_id
    remove_index :refinery_business_order_items, :active
    remove_index :refinery_business_order_items, :position
