  ...
  module Calendar
    describe GoogleCalendar do
      describe 'validations' do
        let(:google_calendar) { FactoryBot.build(:google_calendar) }
        ...
        context 'when google_calendar_id is already present' do
          before { FactoryBot.create(:google_calendar, google_calendar_id: google_calendar.google_calendar_id) }
          it { is_expected.not_to be_valid }
        end
        ...
        context 'when primary_calendar is already present' do
          before { FactoryBot.create(:google_calendar, primary_calendar: google_calendar.primary_calendar) }
          it { is_expected.not_to be_valid }
        end
      ...
      describe '#before_save' do
        let(:google_calendar) { FactoryBot.create(:google_calendar) }
        subject { google_calendar }

        context 'when updating google calendar id' do
          let(:google_calendar) { FactoryBot.create(:google_calendar_with_refresh_token) }
