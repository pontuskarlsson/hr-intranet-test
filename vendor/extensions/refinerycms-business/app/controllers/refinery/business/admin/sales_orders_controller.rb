  ...
  module Business
    module Admin
      class SalesOrdersController < ::Refinery::AdminController
        ...
        #
        #   orders = Refinery::Business::Cin7Importer.get_orders(where: condition)
        #
        ...
        #         item_conditons = orders[1..-1].map { |row| "OrderId=#{ row[Refinery::Business::Cin7Importer::GetOrders::FIELD_ORDER_ID] }" }.join(' OR ')
        #         order_details_result = Refinery::Business::Cin7Importer.get_order_details(where: item_conditons)
        #         order_details_headers = order_details_result[0]
        #         grouped_order_details = order_details_result[1..-1].group_by { |row| row[Refinery::Business::Cin7Importer::GetOrderDetails::FIELD_ORDER_ID] }
        #
        #         orders[1..-1].each do |row|
        #           order_id = row[Refinery::Business::Cin7Importer::GetOrders::FIELD_ORDER_ID]
        #
        ...
        #               order_detail_id = detail_row[Refinery::Business::Cin7Importer::GetOrderDetails::FIELD_ORDER_DETAIL_ID]
        ...
        #   end
        #
        #   redirect_to refinery.business_admin_sales_orders_path
        # end
